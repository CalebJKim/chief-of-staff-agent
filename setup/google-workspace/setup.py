...
SCOPES = [
    # Full Gmail access is required only so cleanup can permanently delete the
    # exact seeded message IDs instead of leaving Trash placeholders in reused
    # demo conversations. Use a dedicated demo account.
