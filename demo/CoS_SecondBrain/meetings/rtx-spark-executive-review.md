...
- The [[openshell|OpenShell]] decision about which outside network connections are allowed.
- The replacement date and preparation time for the [[marketing-shoot|marketing shoot]].

Explain how each issue affects a choice or a deadline rather than listing every unfinished task.

## If the live example cannot be shown
Reviewed screenshots or a narrated walkthrough can still explain the proposed flow. Make clear that this is a walkthrough, not live execution or new performance evidence.

After the meeting, record the actual decisions and remaining questions. A finished deck alone does not mean the story or demos have been approved.
