...
PRE_EMAIL_ROWS = [
    ...
    ["Retail demo readiness", "Unassigned", "Blocked", "The retail demo lane still has no final owner, so the IFA demo slate cannot be presented as closed.", "Assign the final retail demo owner and confirm coverage during the Exec Review.", "", "Final retail demo owner is unassigned.", "Tracker owner field", "DECK_URL", "No owner has been assigned."],
